...
const Session = ({ onBreak, focusDuration, breakDuration }) => {
  if (onBreak) {
   return (
     <div className="mt-2">
 ...
 const Progress = ({ percentComplete, sessionState }) => {
...
const Countdown = ({ timeRemaining, sessionState}) => {
  if (!sessionState.stopped) {
    return (
      ...
      <div>
        ...
        <div className="row mb-2">
          <div className="col">
            ...
            <Countdown sessionState={sessionState} timeRemaining={timeRemaining} />
          </div>
        </div>
        <div className="row mb-2">
          <div className="col">
            <Progress percentComplete={percentComplete} sessionState={sessionState} />
          </div>
        </div>
